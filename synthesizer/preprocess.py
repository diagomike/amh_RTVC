...
def preprocess_dataset(datasets_root: Path, out_dir: Path, n_processes: int, skip_existing: bool, hparams,
    ...
    #? Works Upto here :print(speaker_dirs)
        ...
        if no_alignments:
            ...
            for extension in extensions:
                ...
                for wav_fpath in wav_fpaths:
                    ...
                    print(text_fpath,"Where we are broke")
...
def split_on_silences(wav_fpath, words, end_times, hparams):
    ...
    try:
        ...
        print('This word brought it', words,len(words),len(end_times),len(start_times),end_times)
